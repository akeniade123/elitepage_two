...
// import 'package:elitepage/Controller/requester.dart';
...
class Navigate {
  static Future<String> task(String essence, BuildContext context) async {
    String response = "";
    ...
    switch (essence) {
      ...
      case lsn:
        getReq(enp.getEndpoint(raw, communal, true), rqstElite, essence,
            context, false);
        break;
  ...
  Future<void> LearnTransit(BuildContext context) async {
    Navigate().transit(context, NowPlaying(vmd: curr_vid));
    // Navigate().transit(context, const Login());
  }
  ...
  Future<List<Object>>? getData(
      Map<String, String> data, Map<String, String> tag, String essence) async {
  ...
  Future<Map<String, dynamic>?> eliteApi(
...
/*
  ...
  Future<ServerResponse?> getEliteApi(
      Map<String, Object> tag,
      String domain,
      String essence,
      String designation,
